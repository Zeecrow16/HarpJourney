...
class FindTutorViewModel(
    ...
    private val _selectedDateText = MutableStateFlow("")
    ...
    fun selectAvailability(selectedDates: List<LocalDate>) {
        ...
        _selectedDateText.value = selectedDates.lastOrNull()?.format(DateTimeFormatter.ofPattern("dd MMM yyyy"))
            ?: "No date selected"
    }
